  ...
  return (
    <DropZoneWrapper>
      <DropZone
        ...
        aria-label="Drop backup JSON file here or click to browse"
      >
        {hasFile && (
        ...
        {hasFile ? (
          <>
            ...
            <DropZoneFileName>{fileName}</DropZoneFileName>
          </>
        ) : (
          <>
            <DropZoneTitle>Drop your backup JSON here</DropZoneTitle>
