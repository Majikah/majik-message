...
import type { DecryptSignatureStatus } from "@src/components/panels/_types";
import {
  SignerBadgeBody,
  SignerBadgeDetail,
  SignerBadgeIcon,
...
export const DecryptSignaturePanel: React.FC<DecryptSignaturePanelProps> = ({
  status,
}) => {
    ...
    return (
      <SignerBadgeWrap $variant="unsigned">
        ...
        <SignerBadgeBody>
          ...
          <SignerBadgeDetail>
            This file was not signed at encryption time. Content authenticity
            cannot be verified.
          </SignerBadgeDetail>
        </SignerBadgeBody>
      </SignerBadgeWrap>
    ...
    return (
      <SignerBadgeWrap $variant="invalid">
        ...
        <SignerBadgeBody>
          ...
          <SignerBadgeDetail>
            A signature was found but verification failed. The file may have
            been modified after signing, or the signature was forged. Do not
            trust the contents.
          </SignerBadgeDetail>
          {status.signerId && (
            <SignerBadgeMono>
              Claimed signer: {status.signerId.slice(0, 32)}…
            </SignerBadgeMono>
          )}
        </SignerBadgeBody>
      </SignerBadgeWrap>
    ...
    return (
      <SignerBadgeWrap $variant="warn">
        ...
        <SignerBadgeBody>
          ...
          <SignerBadgeDetail>
            A signature was found but could not be verified — signer public keys
            unavailable.
          </SignerBadgeDetail>
          {status.signerId && (
            <SignerBadgeMono>
              Signer ID: {status.signerId.slice(0, 32)}…
            </SignerBadgeMono>
          )}
        </SignerBadgeBody>
      </SignerBadgeWrap>
  ...
  return (
    <SignerBadgeWrap $variant="valid">
      ...
      <SignerBadgeBody>
        <SignerBadgeTitle>
          ✓ Signature verified · Ed25519 + ML-DSA-87
        </SignerBadgeTitle>
        <SignerBadgeDetail>
          {accountType}
        ...
        {ts && (
          <SignerBadgeDetail style={{ opacity: 0.5 }}>
            Signed {ts}
          </SignerBadgeDetail>
        )}
        {status.signerId && (
          <SignerBadgeMono>{status.signerId.slice(0, 32)}…</SignerBadgeMono>
        )}
      </SignerBadgeBody>
    </SignerBadgeWrap>
  );
