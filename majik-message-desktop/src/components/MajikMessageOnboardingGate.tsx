...
const StatusBadge = styled.span<{ $online: boolean }>`
  ...
  border-radius: 100px;
  background: ${({ $online }) =>
    $online ? "rgba(34,197,94,0.12)" : "rgba(156,163,175,0.12)"};
                  ...
                  {accountMode === "create" && (
                    <>
                      <StepHeader>
                        ...
                        <StepHint>
                          A seed key file will be downloaded automatically. Keep
                          it safe — it&apos;s the only way to recover your
                          account.
                        </StepHint>
                      </StepHeader>
                  ...
                  {accountMode === "import" && (
                    <>
                      <StepHeader>
                        ...
                        <StepHint>
                          Load your backup JSON file and enter the password you
          ...
          <AlertDialog.Portal>
            ...
            <GateContent>
              <DialogHeader>
                ...
                <DialogDescription>
                  Register an account to send and receive messages on the
                  network.
                </DialogDescription>
              </DialogHeader>
              ...
              <StepWrapper>
                ...
                <StepHeader>
                  ...
                  <StepHint>
                    Registering links your public key to the Majikah network so
                    others can message you. Your private key never leaves your
                    device.
                  </StepHint>
                </StepHeader>
