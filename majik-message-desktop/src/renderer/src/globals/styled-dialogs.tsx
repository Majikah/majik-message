...
import { ButtonPrimaryConfirm, type ButtonPrimaryConfirmProps } from './buttons'
...
export const DialogContent = styled(AlertDialog.Content)<DialogContentProps>`
  ...
  z-index: ${({ theme, $zOffset }) => theme.zIndex.overlayContent + ($zOffset || 0)};
...
export const DialogConfirmButton = styled(ButtonPrimaryConfirm)<ButtonPrimaryConfirmProps>`
...
export const DialogCancelButton = styled(ButtonPrimaryConfirm)<ButtonPrimaryConfirmProps>`
  background: ${({ theme }) => theme.colors.primaryBackground};
