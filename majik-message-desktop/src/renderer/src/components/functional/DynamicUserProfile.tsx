...
const HeroCard = styled.div`
  ...
  &::before {
    ...
    width: 300px;
    height: 180px;
    background: radial-gradient(ellipse at top right, rgba(79, 110, 247, 0.06) 0%, transparent 70%);
    pointer-events: none;
  }
`
    ...
    <Root>
      ...
      <PanelHeader>
        <HeaderLeft>
          ...
          <PanelSubtitle>Account Settings &amp; Personal Information</PanelSubtitle>
        </HeaderLeft>
      ...
      <HeroCard>
        ...
        <InfoStrip>
          <InfoCell>
            ...
            <InfoValue data-private>{originalUserAccount?.fullName || 'Not set'}</InfoValue>
          </InfoCell>

          <InfoCell>
            <InfoLabel>Gender</InfoLabel>
            <InfoValue data-private>{originalUserAccount?.gender || 'Unspecified'}</InfoValue>
          </InfoCell>
          ...
          <InfoCell>
            ...
            <InfoValue data-private>{originalUserAccount?.address || 'Not set'}</InfoValue>
          </InfoCell>
        </InfoStrip>
