...
const IconButton = styled.button<{ $darkMode: boolean; $size: number }>`
  ...
  &:hover {
    background: ${({ theme, $darkMode }) =>
      $darkMode ? theme.colors.primaryBackground : theme.colors.primary}; // Hover background color
    color: ${({ theme, $darkMode }) =>
      $darkMode
  ...
  &:disabled {
    ...
    &:hover {
      background: ${({ theme, $darkMode }) =>
        $darkMode ? theme.colors.primaryBackground : 'transparent'}; // Hover background color
    }
  }
